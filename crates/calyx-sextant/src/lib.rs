...
pub use error::{
    ...
    CALYX_SEXTANT_POSTINGS_NOT_SORTED, CALYX_SEXTANT_RERANKER_TIMEOUT,
    CALYX_SEXTANT_SLOT_ALREADY_REGISTERED, CALYX_SEXTANT_SLOT_MISSING, CALYX_SEXTANT_VECTOR_SHAPE,
    sextant_error,
};
