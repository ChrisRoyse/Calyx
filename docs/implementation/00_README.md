...
Stage 8 Ward is the active frontier: #258-#264, #275, and #277 are
FSV-signed-off. PH37 blindspot #278 remains open before the Ward exit can claim
PH37 fully covered; PH38 T02+ continues after that blindspot under epic #257,
and exit remains #280.

**Remaining:** Open Stage 8+ work includes PH37 blindspot #278 plus
**PH38-PH72**,
