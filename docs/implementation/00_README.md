...
#351, #352, and #354 are FSV-signed-off, so PH37 is covered and PH38 T01-T06 plus
the current drift/novelty/timestamp/injection-split/per-slot-calibration
hardening are signed off. PH38 #355, #356, blindspot #279, and PH39 remain under
epic #257, and exit remains #280.
